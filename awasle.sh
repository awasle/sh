...
case $choice in
  ...
  while true; do
    ...
    case $sub_choice in
      ...
      wget -O /home/web/nginx.conf https://raw.githubusercontent.com/awasle/nginx/main/nginx10.conf
      wget -O /home/web/conf.d/default.conf https://raw.githubusercontent.com/awasle/nginx/main/default10.conf
      localhostIP=$(curl -s ipv4.ip.sb)
      sed -i "s/localhost/$localhostIP/g" /home/web/conf.d/default.conf

      # 下载 docker-compose.yml 文件并进行替换
      wget -O /home/web/docker-compose.yml https://raw.githubusercontent.com/awasle/docker/main/LNMP-docker-compose-10.yml

      dbrootpasswd=$(openssl rand -base64 16) && dbuse=$(openssl rand -hex 4) && dbusepasswd=$(openssl rand -base64 8)

      # 在 docker-compose.yml 文件中进行替换
      sed -i "s/webroot/$dbrootpasswd/g" /home/web/docker-compose.yml
      sed -i "s/awasleYYDS/$dbusepasswd/g" /home/web/docker-compose.yml
      sed -i "s/awasle/$dbuse/g" /home/web/docker-compose.yml
      ...
      wget -O /home/web/conf.d/$yuming.conf https://raw.githubusercontent.com/awasle/nginx/main/wordpress.com.conf
      ...
      wget -O /home/web/conf.d/$yuming.conf https://raw.githubusercontent.com/awasle/nginx/main/discuz.com.conf
      ...
      mkdir $yuming
      cd $yuming
      wget https://github.com/awasle/Website_source_code/raw/main/Discuz_X3.5_SC_UTF8_20230520.zip
      ...
      wget -O /home/web/conf.d/$yuming.conf https://raw.githubusercontent.com/awasle/nginx/main/kdy.com.conf
      ...
      wget -O /home/web/conf.d/$yuming.conf https://raw.githubusercontent.com/awasle/nginx/main/maccms.com.conf
      ...
      cd /home/web/html/$yuming/maccms10-master/template/ && wget https://github.com/awasle/Website_source_code/raw/main/DYXS2.zip && unzip DYXS2.zip && rm /home/web/html/$yuming/maccms10-master/template/DYXS2.zip
      ...
      mv /home/web/html/$yuming/maccms10-master/admin.php /home/web/html/$yuming/maccms10-master/vip.php && wget -O /home/web/html/$yuming/maccms10-master/application/extra/maccms.php https://raw.githubusercontent.com/awasle/Website_source_code/main/maccms.php
      ...
      wget -O /home/web/conf.d/$yuming.conf https://raw.githubusercontent.com/awasle/nginx/main/dujiaoka.com.conf
      ...
      wget -O /home/web/conf.d/$yuming.conf https://raw.githubusercontent.com/awasle/nginx/main/reverse-proxy.conf
      sed -i "s/yuming.com/$yuming/g" /home/web/conf.d/$yuming.conf
      ...
      wget -O /home/web/conf.d/$yuming.conf https://raw.githubusercontent.com/awasle/nginx/main/flarum.com.conf
      ...
      wget -O /home/web/conf.d/$yuming.conf https://raw.githubusercontent.com/awasle/nginx/main/rewrite.conf
      sed -i "s/yuming.com/$yuming/g" /home/web/conf.d/$yuming.conf
    ...
    33)
      ...
      wget -O ${useip}_beifen.sh https://raw.githubusercontent.com/awasle/sh/main/beifen.sh > /dev/null 2>&1
    ...
    35)
      if [ -x "$(command -v fail2ban-client)" ] && [ -d "/etc/fail2ban" ]; then
          ...
          curl -sS -O https://raw.githubusercontent.com/awasle/sh/main/sshd.local
          systemctl restart fail2ban
          docker rm -f nginx
          ...
          curl -sS -O https://raw.githubusercontent.com/awasle/sh/main/nginx.local
          systemctl restart fail2ban
          sleep 1
          fail2ban-client status
          echo "防御程序已开启"
    ...
    36)
          while true; do
              ...
              case $sub_choice in
                  ...
                  # php调优
                  wget -O /home/www.conf https://raw.githubusercontent.com/awasle/sh/main/www-1.conf
                  docker cp /home/www.conf php:/usr/local/etc/php-fpm.d/www.conf
                  docker cp /home/www.conf php74:/usr/local/etc/php-fpm.d/www.conf
                  rm -rf /home/www.conf

                  # mysql调优
                  wget -O /home/custom_mysql_config.cnf https://raw.githubusercontent.com/awasle/sh/main/custom_mysql_config-1.cnf
                  ...
                  # php调优
                  wget -O /home/www.conf https://raw.githubusercontent.com/awasle/sh/main/www.conf
                  docker cp /home/www.conf php:/usr/local/etc/php-fpm.d/www.conf
                  docker cp /home/www.conf php74:/usr/local/etc/php-fpm.d/www.conf
                  rm -rf /home/www.conf

                  # mysql调优
                  wget -O /home/custom_mysql_config.cnf https://raw.githubusercontent.com/awasle/sh/main/custom_mysql_config.cnf
                  docker cp /home/custom_mysql_config.cnf mysql:/etc/mysql/conf.d/
                  rm -rf /home/custom_mysql_config.cnf
            ...
            if docker inspect cloudreve &>/dev/null; then
                    ...
                    case $sub_choice in
                        1)
                            ...
                            curl -o /home/docker/cloud/docker-compose.yml https://raw.githubusercontent.com/awasle/docker/main/cloudreve-docker-compose.yml
    ...
    while true; do
      ...
      case $sub_choice in
          1)
              ...
              echo "alias $kuaijiejian='curl -sS -O https://raw.githubusercontent.com/awasle/sh/main/awasle.sh && chmod +x awasle.sh && ./awasle.sh'" >> ~/.bashrc
            ...
            while true; do
                  ...
                  case $sub_choice in
                      1)
                        ...
                        wget -qO - https://raw.githubusercontent.com/awasle/sh/main/archive.key | gpg --dearmor -o /usr/share/keyrings/xanmod-archive-keyring.gpg --yes

                        # 步骤3：添加存储库
                        echo 'deb [signed-by=/usr/share/keyrings/xanmod-archive-keyring.gpg] http://deb.xanmod.org releases main' | tee /etc/apt/sources.list.d/xanmod-release.list

                        # version=$(wget -q https://dl.xanmod.org/check_x86-64_psabi.sh && chmod +x check_x86-64_psabi.sh && ./check_x86-64_psabi.sh | grep -oP 'x86-64-v\K\d+|x86-64-v\d+')
                        version=$(wget -q https://raw.githubusercontent.com/awasle/sh/main/check_x86-64_psabi.sh && chmod +x check_x86-64_psabi.sh && ./check_x86-64_psabi.sh | grep -oP 'x86-64-v\K\d+|x86-64-v\d+')
